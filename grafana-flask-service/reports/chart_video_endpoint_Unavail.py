...
class ChartVideoEndpointUnAvail:
    def __init__(self):
    ...
    def generate_report(self, from_date, to_date, organizations, devices_by_organization):
        query = utils.frame_query("chart_video_unavailability")
    ...
    def generate_chart(self, rows, from_date, to_date):
        ...
        ws['A' + str(chart_row)] = "Video Endpoint UnAvailability Chart (Hours) – " + str(from_date) + " to " + str(
            to_date)
